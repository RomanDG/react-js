...
const BlogItem = ({img, text, metaData, id, title, addLike}) => (
  ...
  <div>
    ...
    <TextBox text={text} />
    <div>
      <Icon name='outline calendar' />: {metaData.createDate} / <Icon name='undo' />: {metaData.updateDate} / <Icon name='user' />: {metaData.author} <LikeBtn addLike={addLike} id={id} />   
    </div>
  </div>
);
