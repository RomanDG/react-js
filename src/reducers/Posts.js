...
export default (state = initialState, action) => {
  switch (action.type) {
    case types.FETCH_POSTS_SUCCESS: console.log(action.response); return Object.assign({},state, {posts: action.response});
    case types.INCREMENT_LIKES:     return Object.assign({},state, state.posts.map((post) => post.id == action.response ? 
